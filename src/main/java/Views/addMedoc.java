 ...
 * @author theHood
 */
public class addMedoc extends javax.swing.JFrame {

    DefaultTableModel tableModel = new DefaultTableModel();
    C_medicament medoc = new C_medicament();
    /**
     * Creates new form addMedoc
     */
    public addMedoc() throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Médicaments en stock");

        jLabel14.setText("Entrer les données du médicament à ajouter...");
    ...
    private void jMenu9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu9MouseClicked
        ...
        try {
            ...
            Logger.getLogger(addMedoc.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addMedoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
