 ...
 * @author theHood
 */
public class unMedicament extends javax.swing.JDialog {

    DefaultTableModel tableModel = new DefaultTableModel();
    C_medicament medoc = new C_medicament();
    /**
     * Creates new form unMedicament
     */
    public unMedicament() throws SQLException {
        initComponents();
        tableModel = medoc.getAllMedoc();
        jTable1.setModel(tableModel);
    }

    private unMedicament(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ajouter de médicaments");
        ...
        jLabel10.setText("Liste de médicaments");
    ...
    private void jMenu5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu5MouseClicked
        ...
        try {
            ...
            Logger.getLogger(unMedicament.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unMedicament.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                unMedicament dialog = new unMedicament(new javax.swing.JFrame(), true);
